$(document).ready(function () {
    ...
    function getpcval(val, key) {
        ...
        var nval = {};
            ...
            nval.pQtyScan = Number(val.StoreCount);
            nval.pQtyAdjustment = Number(val.Qty_Adj);
            nval.pQtyCount = Number(val.StoreCount);
            nval.pCountNumber = 0;
            nval.pBinId = val.bin_id;
            nval.pIsCasePack =0;
            nval.pUserName = SecurityManager.username;
            nval.pMachineName = location.hostname;
