$(document).ready(function () {
    var editor = new $.fn.dataTable.Editor({
        ...
        ajax: {
            "edit": {
                "url": sysSettings.domainPath + "BVSP_VOUCHER_REDEEM",
                "async": true,
                "crossDomain": true,
                "type": "POST",
                "dataType": "json",
    ...
    //// Delete a record
    //$('#CustomerTable').on('click', 'a.editor_remove', function (e) {
    //    e.preventDefault();
    ...
    var table = $("#RedeemVoucherTable").DataTable({
        ...
        { "data": "Campaign_Name" },
        {
            "data": null,
          //"className": "center",
          "defaultContent": '<a href="" class="edit">核销</a>'}
        ],
        "columnDefs": [
            { "width": "5%", "targets": 0 }
        ],
        ajax: {
            "url": sysSettings.domainPath + "BVSP_VOUCHER_SEARCH",
            "async": true,
            "crossDomain": true,
            "type": "POST",
            "dataType": "json",
